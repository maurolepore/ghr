...
The files and datasets you care about are often scattered across multiple GitHub organizations and repositories. How can you easily find and access interesting datasets when you need them?

The ghr (GitHub-R) package helps you to easily explore GitHub directories and access files, directly from R and using a familiar syntax and interface.
...
readr::read_csv(ghr_ls_download_url(path, regexp = "[.]csv$"))
```
