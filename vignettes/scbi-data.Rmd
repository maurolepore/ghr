...
Here I showed how ghr can help to explore and access data of a real research organization. In a single document or shiny app you can now show all of your featured datasets. 

* Use something like `ghr_ls(<path-to-your-GitHub-data>, regexp = "[.]csv$")` to show what your data is and where it is.

* Combine `ghr_ls_download_url()` with `read.csv()` to read .csv files from GitHub into R.

* Combine `ghr_ls_html_url()` with `browseURL()` to show your data on a web browser.
